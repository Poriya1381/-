...
def normalize_username(text):
    ...
    # لینک دعوت خصوصی گروه/کانال روبیکا:
    # https://rubika.ir/joing/<invite_code>
    # لینک خصوصی نباید مثل یوزرنیم عمومی به @ تبدیل شود.
    private_link = re.fullmatch(
        r"https?://(?:www\.)?"
        r"(?:rubika\.ir|web\.rubika\.ir)/"
        r"joing/([A-Za-z0-9_-]{6,128})/?",
        text,
        re.I
    )
    if private_link:
